...
/**
 * Used in the ecan1 interrupt to transfer received messages
 * into the circular buffer.
 * @param message The message to store into the circular buffer.
 */
void rxECAN1(tCanMessage* message);

/**
 * These functions provides a general way to initialize the DMA peripheral.
 *
 * @param parameters An array of uint16s containing all the parameters necessary to initialize the DMA channel. Specific entries documented below.
